...
<script>
    const staffData = [{
            name: "Bất Kì Nhân Viên",
            image: "https://storage.googleapis.com/a1aa/image/0c4cca89-b8c3-442e-7302-258ec924ef72.jpg",
            rating: "5.0"
        },
        {
            name: "Nhân Viên 1",
            image: "https://storage.googleapis.com/a1aa/image/ec408cff-28ae-4751-b3d7-33de936f03a2.jpg",
            rating: "5.0"
        },
        {
            name: "Nhân Viên 2",
    ...
    function redirectToOrderSuccess(staff) {
        ...
        window.location.href = `<?= base_url('/cart/finish') ?>?staff=${encodeURIComponent(staff)}`;
    }
